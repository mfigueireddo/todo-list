...
3. **CONFERIR** Página de recuperação de senha
4. **CONFERIR** Página de visualização/edição/deleção da conta do usuário
...
- Responsável (Referência à tabela de usuários)
- Dificuldade (String) -> Deve ser mostrada como tag
