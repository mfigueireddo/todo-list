...
///
/// <summary>
/// Objetivo: Representar o corpo (payload) enviado pelo frontend ao criar uma tarefa (POST /tasks) — 
...
/// 
/// 2. As anotações de validação (<see cref="RequiredAttribute"/>, <see cref="StringLengthAttribute"/>) 
/// são verificadas automaticamente pelo [ApiController] do TodoList.Api antes de a action executar.
/// </summary>
///
/// <remarks>
/// Atributos:
/// - [Required] (em <see cref="Title"/>): exige que o título seja informado; 
/// sua ausência faz o [ApiController] responder 400 (Bad Request) automaticamente, sem entrar no controller.
/// 
/// - [StringLength] (em <see cref="Title"/> e <see cref="Description"/>): limita o tamanho do texto 
/// aos valores de <see cref="TaskFieldLimits"/>, mantendo a validação alinhada ao HasMaxLength da entidade no banco.
///
/// Restrições:
...
/// 
/// - <see cref="ResponsibleUserId"/> é aceito como anulável, 
/// mas nesta etapa permanece nulo (sem sistema de usuários — ver docs/KNOWN-ISSUES.md).
/// </remarks>
///
