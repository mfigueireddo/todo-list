...
///
/// <summary>
/// Objetivo: Representar o corpo (payload) enviado pelo frontend ao editar uma tarefa existente (PUT /tasks/{id}) — o contrato de entrada da edição, compartilhado entre TodoList.Api e TodoList.Web.
///
/// Descrição:
/// 1. Carrega os mesmos campos da criação E, adicionalmente, o estado de conclusão.
/// 2. Diferente da criação, inclui <see cref="IsCompleted"/> porque a edição pode marcar/desmarcar a tarefa como concluída — inclusive o checkbox da lista usa este mesmo endpoint, apenas alternando esse campo.
/// </summary>
///
/// <remarks>
/// Atributos:
/// - [Required] (em <see cref="Title"/>): exige o título; sua ausência faz o [ApiController] responder 400 (Bad Request) automaticamente.
/// - [StringLength] (em <see cref="Title"/> e <see cref="Description"/>): limita o tamanho aos valores de <see cref="TaskFieldLimits"/>, alinhado ao banco.
///
/// Restrições:
