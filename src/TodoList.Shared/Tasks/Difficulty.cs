...
/// 
/// <para>
/// Representar o grau de dificuldade de uma tarefa como um conjunto fechado de valores 
/// compartilhado entre o backend (TodoList.Api) e o frontend (TodoList.Web).
/// </para>
/// 
/// === <b>Descrição</b> ===
/// 
/// <para>
/// Define os três níveis fixos de dificuldade previstos no projeto.
/// </para>
/// 
/// <para>
/// Por estar em TodoList.Shared, o mesmo tipo é compilado nos dois lados, 
/// garantindo que API e Web concordem exatamente sobre quais valores existem.
/// </para>
/// 
/// </summary>
///
...
/// 
/// <para>
/// Os rótulos de exibição em português ("FÁCIL", "MÉDIA", "DIFÍCIL")
/// e a cor da tag são responsabilidade da camada de UI (TodoList.Web), não deste enum.
/// </para>
/// 
/// </remarks>
