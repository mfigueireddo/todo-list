...
/// 
/// <para>
/// Representar uma tarefa como ela é PERSISTIDA no Microsoft SQL Server — 
...
/// 
/// <para>
/// Reúne os campos de negócio de uma tarefa (título, descrição, data de entrega, dificuldade e conclusão).
/// </para>
/// 
/// <para>
/// Guarda referências a usuários (responsável e criador) como identificadores ANULÁVEIS,
