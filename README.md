...
Estão implementados o **login de usuários** e o **CRUD de tarefas** com as regras de permissão do [`IDEA.md`](docs/IDEA.md). 

Para entrar localmente, use o admin semeado `admin` / `Admin@ICAD!` — ver o passo a passo em [`BUILD.md`](docs/BUILD.md).
